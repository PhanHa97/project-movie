        ...
        <section className="py-6 dark:bg-coolGray-800 dark:text-coolGray-100">
          <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
            ...
            <h1 className="text-4xl font-bold leading-none text-center sm:text-5xl">
              The talended people behind the scenes
            </h1>
            <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
              <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-coolGray-100 dark:text-coolGray-800">
                <img
                  alt=""
                  className="self-center w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-coolGray-500"
                ...
                <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
                  <a
                    href="#a"
                    title="Email"
                    className="dark:text-coolGray-900 hover:dark:text-violet-400"
                  >
                    <svg
              ...
              <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-coolGray-100 dark:text-coolGray-800">
                <img
                  alt=""
                  className="self-center w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-coolGray-500"
                  src="https://source.unsplash.com/101x101/?portrait"
                />
                <div className="flex-1 my-4">
                  <p className="text-xl font-semibold leading-snug">
                    Leroy Jenkins
              ...
              <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-coolGray-100 dark:text-coolGray-800">
                <img
                  alt=""
                  className="self-center w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-coolGray-500"
                  src="https://source.unsplash.com/102x102/?portrait"
                />
                <div className="flex-1 my-4">
                  <p className="text-xl font-semibold leading-snug">
                    Leroy Jenkins
              ...
              <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-coolGray-100 dark:text-coolGray-800">
                <img
                  alt=""
                  className="self-center w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-coolGray-500"
                  src="https://source.unsplash.com/103x103/?portrait"
                />
                <div className="flex-1 my-4">
                  <p className="text-xl font-semibold leading-snug">
                    Leroy Jenkins
              ...
              <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-coolGray-100 dark:text-coolGray-800">
                <img
                  alt=""
                  className="self-center w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-coolGray-500"
                  src="https://source.unsplash.com/104x104/?portrait"
                />
                <div className="flex-1 my-4">
                  <p className="text-xl font-semibold leading-snug">
                    Leroy Jenkins
              ...
              <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-coolGray-100 dark:text-coolGray-800">
                <img
                  alt=""
                  className="self-center w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-coolGray-500"
                  src="https://source.unsplash.com/105x105/?portrait"
                />
                <div className="flex-1 my-4">
                  <p className="text-xl font-semibold leading-snug">
                    Leroy Jenkins
